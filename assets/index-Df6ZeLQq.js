 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(R,T){var P=R.length;R.push(T);e:for(;0<P;){var F=P-1>>>1,A=R[F];if(0<o(A,T))R[F]=T,R[P]=A,P=F;else break e}}function n(R){return R.length===0?null:R[0]}function r(R){if(R.length===0)return null;var T=R[0],P=R.pop();if(P!==T){R[0]=P;e:for(var F=0,A=R.length,je=A>>>1;F<je;){var E=2*(F+1)-1,fn=R[E],I=E+1,Q=R[I];if(0>o(fn,P))I<A&&0>o(Q,fn)?(R[F]=Q,R[I]=P,F=I):(R[F]=fn,R[E]=P,F=E);else if(I<A&&0>o(Q,P))R[F]=Q,R[I]=P,F=I;else break e}}return T}function o(R,T){var P=R.sortIndex-T.sortIndex;return P!==0?P:R.id-T.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var u=[],s=[],c=1,f=null,p=3,m=!1,y=!1,g=!1,S=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(R){for(var T=n(s);T!==null;){if(T.callback===null)r(s);else if(T.startTime<=R)r(s),T.sortIndex=T.expirationTime,t(u,T);else break;T=n(s)}}function w(R){if(g=!1,v(R),!y)if(n(u)!==null)y=!0,W(x);else{var T=n(s);T!==null&&Fe(w,T.startTime-R)}}function x(R,T){y=!1,g&&(g=!1,h(C),C=-1),m=!0;var P=p;try{for(v(T),f=n(u);f!==null&&(!(f.expirationTime>T)||R&&!M());){var F=f.callback;if(typeof F=="function"){f.callback=null,p=f.priorityLevel;var A=F(f.expirationTime<=T);T=e.unstable_now(),typeof A=="function"?f.callback=A:f===n(u)&&r(u),v(T)}else r(u);f=n(u)}if(f!==null)var je=!0;else{var E=n(s);E!==null&&Fe(w,E.startTime-T),je=!1}return je}finally{f=null,p=P,m=!1}}var _=!1,k=null,C=-1,D=5,L=-1;function M(){return!(e.unstable_now()-L<D)}function U(){if(k!==null){var R=e.unstable_now();L=R;var T=!0;try{T=k(!0,R)}finally{T?B():(_=!1,k=null)}}else _=!1}var B;if(typeof d=="function")B=function(){d(U)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,J=K.port2;K.port1.onmessage=U,B=function(){J.postMessage(null)}}else B=function(){S(U,0)};function W(R){k=R,_||(_=!0,B())}function Fe(R,T){C=S(function(){R(e.unstable_now())},T)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(R){R.callback=null},e.unstable_continueExecution=function(){y||m||(y=!0,W(x))},e.unstable_forceFrameRate=function(R){0>R||125<R?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<R?Math.floor(1e3/R):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(R){switch(p){case 1:case 2:case 3:var T=3;break;default:T=p}var P=p;p=T;try{return R()}finally{p=P}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(R,T){switch(R){case 1:case 2:case 3:case 4:case 5:break;default:R=3}var P=p;p=R;try{return T()}finally{p=P}},e.unstable_scheduleCallback=function(R,T,P){var F=e.unstable_now();switch(typeof P=="object"&&P!==null?(P=P.delay,P=typeof P=="number"&&0<P?F+P:F):P=F,R){case 1:var A=-1;break;case 2:A=250;break;case 5:A=1073741823;break;case 4:A=1e4;break;default:A=5e3}return A=P+A,R={id:c++,callback:T,priorityLevel:R,startTime:P,expirationTime:A,sortIndex:-1},P>F?(R.sortIndex=P,t(s,R),n(u)===null&&R===n(s)&&(g?(h(C),C=-1):g=!0,Fe(w,P-F))):(R.sortIndex=A,t(u,R),y||m||(y=!0,W(x))),R},e.unstable_shouldYield=M,e.unstable_wrapCallback=function(R){var T=p;return function(){var P=p;p=T;try{return R.apply(this,arguments)}finally{p=P}}}})(Pc);Cc.exports=Pc;var Ap=Cc.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function ei(){return ei=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},ei.apply(this,arguments)}const ks=z.createContext(null),qm=z.createContext(null),cn=z.createContext(null),Es=z.createContext(null),Si=z.createContext({outlet:null,matches:[],isDataRoute:!1});function eh(e,t){let{relative:n}=t===void 0?{}:t;xi()||We(!1);let{basename:r,navigator:o}=z.useContext(cn),{hash:i,pathname:a,search:l}=Ei(e,{relative:n}),u=a;return r!=="/"&&(u=a==="/"?r:jd([r,a])),o.createHref({pathname:u,search:l,hash:i})}function xi(){return z.useContext(Es)!=null}function ki(){return xi()||We(!1),z.useContext(Es).location}function Od(e){z.useContext(cn).static||z.useLayoutEffect(e)}function th(){let{isDataRoute:e}=z.useContext(Si);return e?lh():nh()}function nh(){xi()||We(!1);let e=z.useContext(ks),{basename:t,future:n,navigator:r}=z.useContext(cn),{matches:o}=z.useContext(Si),{pathname:i}=ki(),a=JSON.stringify(Pd(o,n.v7_relativeSplatPath)),l=z.useRef(!1);return Od(()=>{l.current=!0}),z.useCallback(function(s,c){if(c===void 0&&(c={}),!l.current)return;if(typeof s=="number"){r.go(s);return}let f=Nd(s,JSON.parse(a),i,c.relative==="path");e==null&&t!=="/"&&(f.pathname=f.pathname==="/"?t:jd([t,f.pathname])),(c.replace?r.replace:r.push)(f,c.state,c)},[t,r,a,i,e])}function Ei(e,t){let{relative:n}=t===void 0?{}:t,{future:r}=z.useContext(cn),{matches:o}=z.useContext(Si),{pathname:i}=ki(),a=JSON.stringify(Pd(o,r.v7_relativeSplatPath));return z.useMemo(()=>Nd(e,JSON.parse(a),i,n==="path"),[e,a,i,n])}var Ld=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(Ld||{}),zd=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(zd||{});function rh(e){let t=z.useContext(ks);return t||We(!1),t}function oh(e){let t=z.useContext(Si);return t||We(!1),t}function ih(e){let t=oh(),n=t.matches[t.matches.length-1];return n.route.id||We(!1),n.route.id}function lh(){let{router:e}=rh(Ld.UseNavigateStable),t=ih(zd.UseNavigateStable),n=z.useRef(!1);return Od(()=>{n.current=!0}),z.useCallback(function(o,i){i===void 0&&(i={}),n.current&&(typeof o=="number"?e.navigate(o):e.navigate(o,ei({fromRouteId:t},i)))},[e,t])}function ah(e){let{basename:t="/",children:n=null,location:r,navigationType:o=qt.Pop,navigator:i,static:a=!1,future:l}=e;xi()&&We(!1);let u=t.replace(/^\/*/,"/"),s=z.useMemo(()=>({basename:u,navigator:i,static:a,future:ei({v7_relativeSplatPath:!1},l)}),[u,l,i,a]);typeof r=="string"&&(r=wi(r));let{pathname:c="/",search:f="",hash:p="",state:m=null,key:y="default"}=r,g=z.useMemo(()=>{let S=Mr(c,u);return S==null?null:{location:{pathname:S,search:f,hash:p,state:m,key:y},navigationType:o}},[u,c,f,p,m,y,o]);return g==null?null:z.createElement(cn.Provider,{value:s},z.createElement(Es.Provider,{children:n,value:g}))}new Promise(()=>{});/**
...
`;function _v(e,t){switch(t){case"down":return e?Sv:hv;case"left":return e?xv:vv;case"right":return e?kv:yv;case"up":return e?Ev:gv;default:return e?wv:mv}}const Cv=e=>{const{direction:t,reverse:n=!1,...r}=e,o=z.useMemo(()=>_v(n,t),[t,n]);return fe(Is,{keyframes:o,...r})},Pv=()=>O.jsx("section",{className:"inicio",id:"inicio",children:O.jsxs("div",{className:"inicio__content",children:[O.jsx("div",{className:"inicio__content__type",children:O.jsx(Pl,{direction:"down",triggerOnce:!0,children:O.jsx(Ph,{})})}),O.jsx("div",{className:"inicio__content__parag",children:O.jsx(Pl,{delay:4300,triggerOnce:!0,children:O.jsx("p",{children:"Sean bienvenidos todos a un mundo mental, por mí creado y que por hoy los pienso dejar pasar..."})})}),O.jsx("div",{className:"inicio__button",children:O.jsx(Pl,{delay:5500,direction:"up",triggerOnce:!0,children:O.jsx("a",{href:"#sobre",children:"Conoceme"})})})]})}),Nv="https://escondol.github.io/assets/Resume%20Dojanni%20Contreras-BgASnRVZ.pdf",jv="https://escondol.github.io/assets/certificado_ciber-BG-dm5HK.pdf",Tv="https://escondol.github.io/assets/Crash%20Course%20on%20Python-CsCfYJAR.pdf",Ov="https://escondol.github.io/assets/Introduction%20to%20the%20IoT%20and%20Embedded%20Systems-mvVOGZtB.pdf",Lv="https://escondol.github.io/assets/Interfacing%20with%20the%20Arduino-CM5rPP5e.pdf",zv="https://escondol.github.io/assets/The%20Arduino%20Platform%20and%20C%20Programming-Icb-g7wg.pdf",Rv="https://escondol.github.io/assets/What%20is%20Data%20Science-DoP8Ej2B.pdf",Mv="https://escondol.github.io/assets/Tools%20for%20Data%20Science-BLAb8goy.pdf",$v=()=>O.jsx(O.Fragment,{children:O.jsxs("section",{className:"sobre",id:"sobre",children:[O.jsxs("div",{className:"sobre__presentacion",children:[O.jsx(Cv,{children:O.jsx("h1",{children:"Sobre Mi"})}),O.jsx("p",{children:"Aqui encontrarás información acerca de mi, lo que hago y mis habilidades."}),O.jsx("p",{children:"Soy una personas interesada en todo lo relacionado con la electricidad, electronica y automatización. En estos días estoy enfocado en aprender HTML, CSS y JS."})]}),O.jsx("h2",{className:"Logros",children:"Logros"}),O.jsxs("ul",{className:"ulOne",children:[O.jsx("li",{children:"Documentos Personales"}),O.jsx("ul",{children:O.jsx("li",{children:O.jsx("a",{href:Nv,children:"Curriculum Vitae"})})}),O.jsx("li",{children:"Certificados"}),O.jsxs("ul",{children:[O.jsx("li",{children:O.jsx("a",{href:jv,children:"Taller Introduccion a la Ciberseguridad"})}),O.jsx("li",{children:O.jsx("a",{href:Tv,children:"Crash Course on Python"})}),O.jsx("li",{children:O.jsx("a",{href:Ov,children:"Introduction to the IoT and Embedded Systems"})}),O.jsx("li",{children:O.jsx("a",{href:Lv,children:"Interfacing with the Arduino"})}),O.jsx("li",{children:O.jsx("a",{href:zv,children:"The Arduino Platform and C Programming"})}),O.jsx("li",{children:O.jsx("a",{href:Rv,children:"What is Data Science?"})}),O.jsx("li",{children:O.jsx("a",{href:Mv,children:"Tools for Data Science"})})]})]}),O.jsx("h2",{className:"Logros",children:"Contactame"}),O.jsxs("ul",{className:"Logros",children:[O.jsxs("li",{children:["Correo: ",O.jsx("a",{href:"mailto:esmerling.contreras@gmail.com?Subject=¿Qué%20necesitas%3F%20Con%20gusto%20te%20ayudaré",children:"esmerling.contreras@gmail.com"})]}),O.jsxs("li",{children:["Linkedin: ",O.jsx("a",{href:"https://www.linkedin.com/in/dojanni-contreras-93b31728a/",children:"Dojanni Contreras"})]}),O.jsxs("li",{children:["Github: ",O.jsx("a",{href:"https://github.com/Escondol",children:"Escondol"})]}),O.jsx("li",{children:"Twitter: "})]})]})});function Iv(){return O.jsxs(O.Fragment,{children:[O.jsx(Eh,{}),O.jsx(Pv,{}),O.jsx($v,{})]})}ka.createRoot(document.getElementById("root")).render(O.jsx(kc.StrictMode,{children:O.jsx(hh,{children:O.jsx(Iv,{})})}));
