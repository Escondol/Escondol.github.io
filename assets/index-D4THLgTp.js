 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(z,O){var N=z.length;z.push(O);e:for(;0<N;){var F=N-1>>>1,A=z[F];if(0<o(A,O))z[F]=O,z[N]=A,N=F;else break e}}function n(z){return z.length===0?null:z[0]}function r(z){if(z.length===0)return null;var O=z[0],N=z.pop();if(N!==O){z[0]=N;e:for(var F=0,A=z.length,je=A>>>1;F<je;){var _=2*(F+1)-1,fn=z[_],I=_+1,Q=z[I];if(0>o(fn,N))I<A&&0>o(Q,fn)?(z[F]=Q,z[I]=N,F=I):(z[F]=fn,z[_]=N,F=_);else if(I<A&&0>o(Q,N))z[F]=Q,z[I]=N,F=I;else break e}}return O}function o(z,O){var N=z.sortIndex-O.sortIndex;return N!==0?N:z.id-O.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var u=[],s=[],c=1,f=null,p=3,m=!1,y=!1,g=!1,x=typeof setTimeout=="function"?setTimeout:null,h=typeof clearTimeout=="function"?clearTimeout:null,d=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(z){for(var O=n(s);O!==null;){if(O.callback===null)r(s);else if(O.startTime<=z)r(s),O.sortIndex=O.expirationTime,t(u,O);else break;O=n(s)}}function w(z){if(g=!1,v(z),!y)if(n(u)!==null)y=!0,W(S);else{var O=n(s);O!==null&&Fe(w,O.startTime-z)}}function S(z,O){y=!1,g&&(g=!1,h(P),P=-1),m=!0;var N=p;try{for(v(O),f=n(u);f!==null&&(!(f.expirationTime>O)||z&&!M());){var F=f.callback;if(typeof F=="function"){f.callback=null,p=f.priorityLevel;var A=F(f.expirationTime<=O);O=e.unstable_now(),typeof A=="function"?f.callback=A:f===n(u)&&r(u),v(O)}else r(u);f=n(u)}if(f!==null)var je=!0;else{var _=n(s);_!==null&&Fe(w,_.startTime-O),je=!1}return je}finally{f=null,p=N,m=!1}}var E=!1,k=null,P=-1,D=5,L=-1;function M(){return!(e.unstable_now()-L<D)}function U(){if(k!==null){var z=e.unstable_now();L=z;var O=!0;try{O=k(!0,z)}finally{O?B():(E=!1,k=null)}}else E=!1}var B;if(typeof d=="function")B=function(){d(U)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,J=K.port2;K.port1.onmessage=U,B=function(){J.postMessage(null)}}else B=function(){x(U,0)};function W(z){k=z,E||(E=!0,B())}function Fe(z,O){P=x(function(){z(e.unstable_now())},O)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(z){z.callback=null},e.unstable_continueExecution=function(){y||m||(y=!0,W(S))},e.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<z?Math.floor(1e3/z):5},e.unstable_getCurrentPriorityLevel=function(){return p},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(z){switch(p){case 1:case 2:case 3:var O=3;break;default:O=p}var N=p;p=O;try{return z()}finally{p=N}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(z,O){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var N=p;p=z;try{return O()}finally{p=N}},e.unstable_scheduleCallback=function(z,O,N){var F=e.unstable_now();switch(typeof N=="object"&&N!==null?(N=N.delay,N=typeof N=="number"&&0<N?F+N:F):N=F,z){case 1:var A=-1;break;case 2:A=250;break;case 5:A=1073741823;break;case 4:A=1e4;break;default:A=5e3}return A=N+A,z={id:c++,callback:O,priorityLevel:z,startTime:N,expirationTime:A,sortIndex:-1},N>F?(z.sortIndex=N,t(s,z),n(u)===null&&z===n(s)&&(g?(h(P),P=-1):g=!0,Fe(w,N-F))):(z.sortIndex=A,t(u,z),y||m||(y=!0,W(S))),z},e.unstable_shouldYield=M,e.unstable_wrapCallback=function(z){var O=p;return function(){var N=p;p=O;try{return z.apply(this,arguments)}finally{p=N}}}})(Pc);Cc.exports=Pc;var Ap=Cc.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function ei(){return ei=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},ei.apply(this,arguments)}const ks=R.createContext(null),qm=R.createContext(null),cn=R.createContext(null),_s=R.createContext(null),xi=R.createContext({outlet:null,matches:[],isDataRoute:!1});function eh(e,t){let{relative:n}=t===void 0?{}:t;Si()||We(!1);let{basename:r,navigator:o}=R.useContext(cn),{hash:i,pathname:a,search:l}=_i(e,{relative:n}),u=a;return r!=="/"&&(u=a==="/"?r:jd([r,a])),o.createHref({pathname:u,search:l,hash:i})}function Si(){return R.useContext(_s)!=null}function ki(){return Si()||We(!1),R.useContext(_s).location}function Od(e){R.useContext(cn).static||R.useLayoutEffect(e)}function th(){let{isDataRoute:e}=R.useContext(xi);return e?lh():nh()}function nh(){Si()||We(!1);let e=R.useContext(ks),{basename:t,future:n,navigator:r}=R.useContext(cn),{matches:o}=R.useContext(xi),{pathname:i}=ki(),a=JSON.stringify(Pd(o,n.v7_relativeSplatPath)),l=R.useRef(!1);return Od(()=>{l.current=!0}),R.useCallback(function(s,c){if(c===void 0&&(c={}),!l.current)return;if(typeof s=="number"){r.go(s);return}let f=Nd(s,JSON.parse(a),i,c.relative==="path");e==null&&t!=="/"&&(f.pathname=f.pathname==="/"?t:jd([t,f.pathname])),(c.replace?r.replace:r.push)(f,c.state,c)},[t,r,a,i,e])}function _i(e,t){let{relative:n}=t===void 0?{}:t,{future:r}=R.useContext(cn),{matches:o}=R.useContext(xi),{pathname:i}=ki(),a=JSON.stringify(Pd(o,r.v7_relativeSplatPath));return R.useMemo(()=>Nd(e,JSON.parse(a),i,n==="path"),[e,a,i,n])}var Ld=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(Ld||{}),Rd=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(Rd||{});function rh(e){let t=R.useContext(ks);return t||We(!1),t}function oh(e){let t=R.useContext(xi);return t||We(!1),t}function ih(e){let t=oh(),n=t.matches[t.matches.length-1];return n.route.id||We(!1),n.route.id}function lh(){let{router:e}=rh(Ld.UseNavigateStable),t=ih(Rd.UseNavigateStable),n=R.useRef(!1);return Od(()=>{n.current=!0}),R.useCallback(function(o,i){i===void 0&&(i={}),n.current&&(typeof o=="number"?e.navigate(o):e.navigate(o,ei({fromRouteId:t},i)))},[e,t])}function ah(e){let{basename:t="/",children:n=null,location:r,navigationType:o=qt.Pop,navigator:i,static:a=!1,future:l}=e;Si()&&We(!1);let u=t.replace(/^\/*/,"/"),s=R.useMemo(()=>({basename:u,navigator:i,static:a,future:ei({v7_relativeSplatPath:!1},l)}),[u,l,i,a]);typeof r=="string"&&(r=wi(r));let{pathname:c="/",search:f="",hash:p="",state:m=null,key:y="default"}=r,g=R.useMemo(()=>{let x=Mr(c,u);return x==null?null:{location:{pathname:x,search:f,hash:p,state:m,key:y},navigationType:o}},[u,c,f,p,m,y,o]);return g==null?null:R.createElement(cn.Provider,{value:s},R.createElement(_s.Provider,{children:n,value:g}))}new Promise(()=>{});/**
...
`;function Ev(e,t){switch(t){case"down":return e?xv:hv;case"left":return e?Sv:vv;case"right":return e?kv:yv;case"up":return e?_v:gv;default:return e?wv:mv}}const Cv=e=>{const{direction:t,reverse:n=!1,...r}=e,o=R.useMemo(()=>Ev(n,t),[t,n]);return fe(Is,{keyframes:o,...r})},Pv=()=>C.jsx("section",{className:"inicio",id:"inicio",children:C.jsxs("div",{className:"inicio__content",children:[C.jsx("div",{className:"inicio__content__type",children:C.jsx(Pl,{direction:"down",triggerOnce:!0,children:C.jsx(Ph,{})})}),C.jsx("div",{className:"inicio__content__parag",children:C.jsx(Pl,{delay:4300,triggerOnce:!0,children:C.jsx("p",{children:"Sean bienvenidos todos a un mundo mental, por mí creado y que por hoy los pienso dejar pasar..."})})}),C.jsx("div",{className:"inicio__button",children:C.jsx(Pl,{delay:5500,direction:"up",triggerOnce:!0,children:C.jsx("a",{href:"#sobre",children:"Proyectos"})})})]})}),Nv="https://escondol.github.io/assets/Resume%20Dojanni%20Contreras-BgASnRVZ.pdf",jv="https://escondol.github.io/assets/certificado_ciber-BG-dm5HK.pdf",Tv="https://escondol.github.io/assets/Crash%20Course%20on%20Python-CsCfYJAR.pdf",Ov="https://escondol.github.io/assets/Introduction%20to%20the%20IoT%20and%20Embedded%20Systems-mvVOGZtB.pdf",Lv="https://escondol.github.io/assets/Interfacing%20with%20the%20Arduino-CM5rPP5e.pdf",Rv="https://escondol.github.io/assets/The%20Arduino%20Platform%20and%20C%20Programming-Icb-g7wg.pdf",zv="https://escondol.github.io/assets/What%20is%20Data%20Science-DoP8Ej2B.pdf",Mv="https://escondol.github.io/assets/Tools%20for%20Data%20Science-BLAb8goy.pdf",$v=()=>C.jsx(C.Fragment,{children:C.jsxs("section",{className:"sobre",id:"sobre",children:[C.jsxs("div",{className:"sobre__presentacion",children:[C.jsx(Cv,{children:C.jsx("h1",{children:"Sobre Mí"})}),C.jsx("p",{children:"Aqui encontrarás información acerca de mi, lo que hago y mis habilidades."})]}),C.jsxs("div",{className:"sobre__content",children:[C.jsxs("div",{className:"sobre__content__conoceme",children:[C.jsx("h2",{children:"Conóceme!"}),C.jsx("p",{children:"Soy una persona interesada en todo lo relacionado con la electricidad, electronica y automatización. En estos días estoy enfocado en aprender HTML, CSS y JS para poder tener mi propia página web que represente mi portafolio."})]}),C.jsxs("div",{className:"sobre__content__logros",children:[C.jsx("h2",{children:"Logros"}),C.jsxs("ul",{children:[C.jsx("li",{children:"Documentos Personales"}),C.jsx("ul",{children:C.jsx("li",{children:C.jsx("a",{href:Nv,children:"Curriculum Vitae"})})}),C.jsx("li",{children:"Certificados"}),C.jsxs("ul",{children:[C.jsx("li",{children:C.jsx("a",{href:jv,children:"Taller Introduccion a la Ciberseguridad"})}),C.jsx("li",{children:C.jsx("a",{href:Tv,children:"Crash Course on Python"})}),C.jsx("li",{children:C.jsx("a",{href:Ov,children:"Introduction to the IoT and Embedded Systems"})}),C.jsx("li",{children:C.jsx("a",{href:Lv,children:"Interfacing with the Arduino"})}),C.jsx("li",{children:C.jsx("a",{href:Rv,children:"The Arduino Platform and C Programming"})}),C.jsx("li",{children:C.jsx("a",{href:zv,children:"What is Data Science?"})}),C.jsx("li",{children:C.jsx("a",{href:Mv,children:"Tools for Data Science"})})]})]})]}),C.jsxs("div",{className:"sobre__content_habilidades",children:[C.jsx("h2",{children:"Habilidades"}),C.jsxs("ul",{children:[C.jsx("li",{children:"KiCad"}),C.jsx("li",{children:"EasyEDA"}),C.jsx("li",{children:"Fusion 360"}),C.jsx("li",{children:"AutoCad"}),C.jsx("li",{children:"Github"}),C.jsx("li",{children:"MATLAB"}),C.jsx("li",{children:"C/C++"}),C.jsx("li",{children:"Python"}),C.jsx("li",{children:"HTML"}),C.jsx("li",{children:"CSS"}),C.jsx("li",{children:"GRAFCET"}),C.jsx("li",{children:"Ladder"}),C.jsx("li",{children:"Controles Eléctricos"})]})]}),C.jsx("h2",{children:"Contactame"}),C.jsxs("ul",{children:[C.jsxs("li",{children:["Correo: ",C.jsx("a",{href:"mailto:esmerling.contreras@gmail.com?Subject=¿Qué%20necesitas%3F%20Con%20gusto%20te%20ayudaré",children:"esmerling.contreras@gmail.com"})]}),C.jsxs("li",{children:["Linkedin: ",C.jsx("a",{href:"https://www.linkedin.com/in/dojanni-contreras-93b31728a/",children:"Dojanni Contreras"})]}),C.jsxs("li",{children:["Github: ",C.jsx("a",{href:"https://github.com/Escondol",children:"Escondol"})]}),C.jsx("li",{children:"Twitter: "})]})]})]})});function Iv(){return C.jsxs(C.Fragment,{children:[C.jsx(_h,{}),C.jsx(Pv,{}),C.jsx($v,{})]})}ka.createRoot(document.getElementById("root")).render(C.jsx(kc.StrictMode,{children:C.jsx(hh,{children:C.jsx(Iv,{})})}));
